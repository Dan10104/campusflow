        ...
        <section class="relative isolate min-h-[calc(100vh-var(--cf-header-height))] overflow-hidden bg-[var(--cf-bg)] px-4 py-8 text-[var(--cf-text)] sm:px-6 lg:px-8">
            ...
            <div class="relative mx-auto grid max-w-6xl items-center gap-8 py-4 lg:grid-cols-[0.95fr_1.05fr] lg:py-10">
                <aside class="hidden rounded-lg border border-white/10 bg-[#0B1F3A] p-8 text-white shadow-[0_24px_60px_rgba(11,31,58,0.28)] lg:block">
                    ...
                    <div class="mt-12">
                        <p class="text-sm font-semibold text-[#06B6D4]">Restablecimiento seguro</p>
                        <h1 class="mt-3 text-4xl font-black leading-tight text-white">Define una nueva contraseña para volver al sistema.</h1>
                        <p class="mt-5 max-w-lg text-base leading-7 text-white/72">
                            El enlace recibido valida esta operacion. El token y el correo se conservan en el formulario enviado al backend.
                        </p>
                    </div>

                    <div class="mt-10 flex items-start gap-3 border-t border-white/10 pt-8">
                        <KeyIcon class="mt-0.5 h-5 w-5 flex-none text-[#06B6D4]" />
                        <p class="text-sm leading-6 text-white/78">Elige una contraseña privada y evita compartirla con otras personas.</p>
                    </div>
                </aside>
                ...
                <div class="mx-auto w-full max-w-lg rounded-lg border border-[var(--cf-border)] bg-[var(--cf-surface)] p-6 shadow-[var(--cf-shadow-md)] sm:p-8">
                    ...
                    <div class="mt-8">
                        <p class="text-sm font-bold uppercase tracking-[0.16em] text-[#2563EB]">Seguridad de cuenta</p>
                        <h2 class="mt-2 text-3xl font-black tracking-normal text-[var(--cf-heading)]">Definir nueva contraseña</h2>
